...
| https://claimable.neon.tech | Function + Vercel forwarder. DNS not pointed. |
...
| Neon Function + Vercel forwarder, dedicated https://track.neon.tech write key, expiry janitor cron, claimable.neon.tech DNS. | Function and forwarder exist. Remaining blockers for going live: DNS, dbx-owned Function org, write key, cron. |
...
Still open: `claimable.neon.tech` DNS, a dbx-owned Function org, a dedicated https://track.neon.tech
write key, and automatic deletion of expired unclaimed projects (blocked on Functions cron). The
Vercel forwarder is temporary until Functions can bind a custom hostname.
